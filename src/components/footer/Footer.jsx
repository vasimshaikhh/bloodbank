...
const Footer = () => {
  return (
    <>
      <Box sx={{ height:{lg:'20rem',md:'20rem',xs:'55rem',sm:'55rem'},backgroundColor: "#ff5722",mt:'8rem',color:'#fff',display:'flex',justifyContent:'center',alignItems:'center'}}>
              ...
              <Stack direction={"column"}>
                ...
                <Stack direction={"column"} spacing={1}>
                  ...
                  <Link to="/bloodbank" style={{ textDecoration: "none" }}>
                    <Typography variant="body2" sx={{color:'#fff'}}>Blood Bank</Typography>
                  </Link>
                  <Link to="/cause" style={{ textDecoration: "none" }}>
                    <Typography variant="body2" sx={{color:'#fff'}}>cause</Typography>
                  </Link>
                  <Link to="/contactus" style={{ textDecoration: "none" }}>
                    <Typography variant="body2" sx={{color:'#fff'}}>contactus</Typography>
                  </Link>
                  <Link to="/donateus" style={{ textDecoration: "none" }}>
                    <Typography variant="body2" sx={{color:'#fff'}}>donateus</Typography>
                  </Link>
                </Stack>
              </Stack>
            </Grid>
